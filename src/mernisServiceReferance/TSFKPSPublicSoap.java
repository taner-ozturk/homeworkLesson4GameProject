...
public class TSFKPSPublicSoap
{
    ...
    public TSFKPSPublicSoap(){}

    public TSFKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public TSFKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        TSFExtendedSoapSerializationEnvelope envelope= new TSFExtendedSoapSerializationEnvelope(TSFExtendedSoapSerializationEnvelope.VER11);
