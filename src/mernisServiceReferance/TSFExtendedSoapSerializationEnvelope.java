...
public class TSFExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(TSFDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new TSFStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static TSFDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static TSFDateTimeConverter dateTimeConverter = new TSFStandardDateTimeConverter();

    public TSFExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public TSFExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new TSFMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=TSFHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,TSFExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=TSFHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
